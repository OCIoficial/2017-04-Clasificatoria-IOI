...
\begin{inputDescription}
  ...
  ($0\leq a \leq b \leq c \leq 50$) correspondientes a la cantidad de bombas de fuego,
...
\begin{scoreDescription}
  \score{10} Se probarán varios casos donde $a = b = 0$.
  \score{15} Se probarán varios casos donde $a = 0$ y $c - b \leq 2$.
  \score{32} Se probarán varios casos donde $b - a \leq 2$
  \score{43} Se probarán varios casos donde sin restricciones adicionales.
