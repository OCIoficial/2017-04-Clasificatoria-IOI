...
\begin{problemDescription}
  ...
  $(8-4)\times 2=4\times 2=8$ nlogdolares si se quiere modificar la autopista
...
\begin{scoreDescription}
  \score{9} Se probarán varios casos donde $A_i=A_j$ para todo $i,j$ y además
  $1 \leq A_i \leq 10^9$.
  \score{20} Se probarán varios casos donde $1 \leq A_i \leq 10$.
  \score{31} Se probarán varios casos donde $N=2$ y $1\leq A_i \leq 10^5$.
  \score{40} Se probarán varios casos donde $1\leq A_i\leq 10^5$.
